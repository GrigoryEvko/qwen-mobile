...
SCENARIOS="image-shape image-twice jni-pending spec-disable spec-parity spec-image snapshot-damage image-damage sampler-nan stop-free priority"
...
phone_commands() {
    ...
    for dev in cpu HTP0; do
        for sc in image-shape spec-disable spec-parity spec-image snapshot-damage image-damage sampler-nan jni-pending stop-free priority; do
